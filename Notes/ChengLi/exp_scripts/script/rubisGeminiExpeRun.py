...
if __name__ == '__main__':
    ...
    '''
    if len(sys.argv) != 17:
        print "Usage: python rubisGeminiExpeRun.py ntfIP ntfPath userName pwd dbFile testName configFile tpcwConfigFile appThdCount proxyThdCount coorThdCount sshimThdCount debug isAmazon nodes.db DeployOrConfigOrRun"
        sys.exit()
    option = sys.argv[1:]
